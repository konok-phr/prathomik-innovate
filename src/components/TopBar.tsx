...
const TopBar = () => {
  return (
    <div className="fixed top-0 left-0 right-0 bg-background border-b border-primary/20 py-2 z-[60]">
      <div className="container px-4 sm:px-6 flex items-center justify-center gap-4 sm:gap-8 text-xs sm:text-sm">
        ...
        >
          ...
          <span className="font-medium">+880 1XXX-XXXXXX</span>
        </a>
        ...
        >
          ...
          <span className="font-medium">hello@prathomik.com</span>
        </a>
      </div>
    </div>
  );

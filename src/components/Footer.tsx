        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-gradient-cyan-soft border border-primary/20 hover:border-primary/40 transition-all text-sm font-medium text-foreground hover:text-primary"
            >
            ...
            <p className="text-xs text-muted-foreground mt-2">+880 1XXX-XXXXXX</p>
          </div>
        </div>
